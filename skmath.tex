...
\end{example}
  ...
  \DescribeMacro\pd*{<function>}{<var>,<var>,...}
...
\end{MacroCode}
  ...
  \begin{macro*}{\__skmath_if_numerical:n}[1]
    {Token or string}
\begin{MacroCode}{package}
...
\cs_new_nopar:Npn\__skmath_pd_vars_sum:n#1{
  ...
  \int_compare:nT{\l_tmpa_int>0}{\int_use:N\l_tmpa_int}
...
\cs_new_nopar:Npn\__skmath_pd_fraction:nn#1#2{
  \frac{
    \partial\c_math_superscript_token{
      \__skmath_pd_vars_sum:n{#2}
    }
    {#1}
  }{
