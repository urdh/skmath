...
\begin{document}
  ...
  real, complex and prime numbers respectively.
\begin{example}
\begin{equation*}
  \N, \Z, \Q, \R, \C, \P.
\end{equation*}
...
\keys_define:nn{skmath / internal}{
  ...
  integral-d / upright .code:n = { \cs_gset_eq:NN\__skmath_integral_d:\operator@font },
  integral-d / slanted .code:n = { \cs_gset_eq:NN\__skmath_integral_d:\relax },
  isomath .bool_set:N = \g__skmath_load_isomath_bool,
  isomath .value_required:,
  natural-log .choice:,
  natural-log .value_required:,
  natural-log / upright .code:n = { \cs_gset_nopar:Npn\__skmath_natural_log_base_fmt:n#1{{\operator@font #1}} },
  natural-log / slanted .code:n = { \cs_gset_nopar:Npn\__skmath_natural_log_base_fmt:n#1{{#1}} },
}
\end{MacroCode}
...
\end{MacroCode}
  \end{macro}
  \begin{macro}{\P}
  \changes{0.4}{Added macro for set of prime numbers}
\begin{MacroCode}{package}
  \NewDocumentCommand\P{}{\ensuremath{\mathbb{P}}}
\end{MacroCode}
  \end{macro}
\begin{MacroCode}{package}
}
...
\RenewDocumentCommand\exp{sm}{\ensuremath{
  \IfBooleanTF{#1}{
    ...
    \mathchoice
      {\__skmath_natural_log_base_fmt:n{e}\c_math_superscript_token{#2}}
...
\begin{MacroCode}{package}
\DeclareDocumentCommand\d{m}{\ensuremath{\,{\__skmath_integral_d: d}#1%
