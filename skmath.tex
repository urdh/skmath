...
%% 
%% This work consists of the file skmath.tex and the derived
%% and the derived file skmath.sty.
\documentclass[commonsets,load]{skdoc}

% Provide fake versions of the commands defined by the package
...
% Provide fake versions of the amsmath stuff as well
...
\begin{document}
  ...
  % Metadata
  \package[ctan,vcs=https://github.com/urdh/skmath]{skmath}
